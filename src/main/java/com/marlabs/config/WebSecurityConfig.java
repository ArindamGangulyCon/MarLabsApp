...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * .hasAnyRole("USER", "ADMIN").antMatchers("/getQuestion").hasAnyRole("USER",
	 * "ADMIN") .antMatchers("/submitAnswer").hasAnyRole("USER", "ADMIN")
	 ...
	 * authenticationMgr.inMemoryAuthentication().withUser("mathsadmin").password(
	 * "mathsadmin")
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				.antMatchers("/submitAnswer").permitAll()
